...
public class DateUtil {
    ...
    public static String getDate(Date time) {
        return DateFormatUtils.format(time, "yyyy-MM-dd HH:mm:ss", DEFAULT_LOCALE);
    }
     ...
     * @return
     */
    public static String getDate(Date time, String f) {
        return DateFormatUtils.format(time, f, DEFAULT_LOCALE);
    }
