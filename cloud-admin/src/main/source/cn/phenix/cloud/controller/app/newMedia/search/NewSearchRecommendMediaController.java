...
@Controller
@Api(tags ="推荐管理")
@RequestMapping("/platform/search/recommend")
public class NewSearchRecommendMediaController extends BaseController {
    @Autowired
    ...
    public String index(HttpServletRequest req,
        ...
        return "app/newMedia/search/index";
    ...
    public String detail(String id,Model model,HttpServletRequest req,
        ...
        return "app/newMedia/search/detail";
    }
    ...
    public Result setRecommend(String mediaId,String isRecommend) {
        if(isRecommend.equals("1")){//设为推荐
            ...
            NewSearchRecommendMedia ftsearchRecommendMedia = new NewSearchRecommendMedia();
            ftsearchRecommendMedia.setMediaSeries(mediaSeries);
            newSearchRecommendMediaService.save(ftsearchRecommendMedia);
        }else{//取消推荐
            mediaSeriesService.updateIsRecommend(mediaId,isRecommend);
            newSearchRecommendMediaService.deleteByMediaId(mediaId);
        }
