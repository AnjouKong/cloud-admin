...
@Controller
@RequestMapping("platform/dataAnalysis/play")
@Api(tags = "播放订单分析")
@RequiresPermissions("sys.manager.unit")
public class PlayEventController extends BaseController {
    ...
    public String index(Model model) {
        ...
        return "app/dataAnalysis/play/index";
    }
