...
import cn.phenix.cloud.admin.app.newMedia.converge.service.NewMediaConvergeRuleService;
...
@Controller
@Api(tags ="媒资聚合规则")
@RequestMapping("/platform/newMedia/converge/rule")
public class NewMediaConvergeRuleController extends BaseController {
    @Autowired
    private NewMediaConvergeRuleService mediaConvergeRuleService;
    @Autowired
    ...
    @ApiOperation("首页跳转")
    public String index() {
        return "app/newMedia/converge/rule/index";
    }
    ...
    @ApiOperation("首页数据加载")
    public PageTable<NewMediaConvergeRule> data(NewMediaConvergeRule mediaConvergeRule, Integer draw, DataTableParameter parameter) {

        PageTable<NewMediaConvergeRule> pageTable = mediaConvergeRuleService.findPage(parameter,mediaConvergeRule);
    ...
    @ApiOperation("添加页面跳转")
    public String add() {
        return "app/newMedia/converge/rule/add";
    }
    ...
    @ApiOperation("添加数据")
    public Result addDo(NewMediaConvergeRule mediaConvergeRule) {
    ...
    public String edit(@PathVariable("id") String id, Model model) {
        NewMediaConvergeRule mediaConvergeRule = mediaConvergeRuleService.get(id);
        model.addAttribute("obj", mediaConvergeRule);
        return "app/newMedia/converge/rule/edit";
    }
    ...
    @RequiresPermissions("sys.manager.unit")
    @ApiOperation("编辑数据")
    public Result editDo(NewMediaConvergeRule mediaConvergeRule,String oldCode) {
        if (mediaConvergeRule!=null) {
    ...
    public String detail(@PathVariable("id") String id, Model model) {
        NewMediaConvergeRule mediaConvergeRule = mediaConvergeRuleService.get(id);
        model.addAttribute("obj", mediaConvergeRule);
        return "app/newMedia/converge/rule/detail";
    }
    ...
    public List<Map<String, Object>> ruleTree() {
        List<NewMediaConvergeRule> list = mediaConvergeRuleService.findByDelFlag(Brand.DEL_FLAG_NORMAL);
        List<Map<String, Object>> tree = new ArrayList<>();
        for (NewMediaConvergeRule convergeRule : list) {
