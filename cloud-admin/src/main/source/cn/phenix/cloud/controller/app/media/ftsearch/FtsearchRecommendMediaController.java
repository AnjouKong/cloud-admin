...
@Controller
@Api(tags ="推荐管理")
@RequestMapping("/platform/ftsearch/recommend")
public class FtsearchRecommendMediaController extends BaseController {
    @Autowired
    ...
    public String index(HttpServletRequest req,String levelId,
        ...
        return "app/media/ftsearch/index";
    ...
    public String detail(String id,Model model,HttpServletRequest req,String levelId,
        ...
        return "app/media/ftsearch/detail";
    }
    ...
    @ResponseBody
    @ApiOperation(value = "设为推荐")
    public Result setRecommend(String mediaId,String levelId,String isRecommend) {
        if(isRecommend.equals("1")){//设为推荐
            mediaSeriesService.updateIsRecommend(mediaId,isRecommend);

            MediaSeries mediaSeries=mediaSeriesService.get(mediaId);
            FtsearchRecommendMedia ftsearchRecommendMedia = new FtsearchRecommendMedia();
            ftsearchRecommendMedia.setMediaSeries(mediaSeries);
            ftsearchRecommendMedia.setLevelId(levelId);
            ftsearchRecommendMediaService.save(ftsearchRecommendMedia);
        }else{//取消推荐
            mediaSeriesService.updateIsRecommend(mediaId,isRecommend);
            ftsearchRecommendMediaService.deleteByLevelIdAndMediaId(levelId,mediaId);
        }
