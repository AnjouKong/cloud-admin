package cn.phenix.cloud.controller.app.media.cibn;


import cn.phenix.cloud.admin.app.media.cibn.service.CIBNCategoryService;
import cn.phenix.cloud.admin.app.media.cibn.service.CIBNListService;
...
@Controller
@Api(tags = "cibn媒资列表")
@RequestMapping("platform/cibn/list")
public class CibnListController extends BaseController{
    @Autowired
    private CIBNListService cibnListService;
    @Autowired
    private CIBNCategoryService cibnCategoryService;
