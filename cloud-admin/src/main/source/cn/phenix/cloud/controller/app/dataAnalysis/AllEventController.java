...
import cn.phenix.cloud.log.service.AllEventService;
...
@Controller
@RequestMapping("platform/dataAnalysis/all")
@Api(tags = "设备事件")
@RequiresPermissions("sys.manager.unit")
public class AllEventController extends BaseController {
    ...
    public String index(Model model) {
        ...
        return "app/dataAnalysis/all/index";
    }
