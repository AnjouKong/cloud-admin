...
@Setter
@Entity
@Table(name = "MEDIA_HOMEPAGE_TOP")
public class NewMediaHomePageTop extends BaseModel {

    private static final long serialVersionUID = 1L;

    public static final String modelName="cn.phenix.model.app.newMedia.NewMediaHomePageTop";
