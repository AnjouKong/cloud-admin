...
public class NewMediaSubject extends BaseModel {

    private static final long serialVersionUID = 1L;

    public static final String modelName = "cn.phenix.model.app.newMedia.NewMediaSubject";
    ...
    private List<NewMediaSubjectDetail> mediaList = Lists.newArrayList();
    ...
    public NewMediaSubject() {
    }

    public NewMediaSubject(String id) {
        super();
        this.id = id;
    }
}
