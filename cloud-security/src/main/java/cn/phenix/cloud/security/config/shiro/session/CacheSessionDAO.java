package cn.phenix.cloud.security.config.shiro.session;

import cn.phenix.cloud.core.utils.DateUtils;
import cn.phenix.cloud.core.utils.IdGen;
import cn.phenix.cloud.core.web.Servlets;
...
public class CacheSessionDAO extends EnterpriseCacheSessionDAO implements SessionDAO,InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		setSessionIdGenerator(new SessionIdGen());
	...
	class SessionIdGen implements SessionIdGenerator {
