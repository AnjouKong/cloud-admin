 ...
 *
 * @author xiaobin
 * @create 2017-11-27 下午3:12
 **/
@Repository
public class AllEventDao {
    ...
    public Page<LogDeviceEventV1Vo> findPage(Pageable pagination, LogDeviceEventV1Vo eventV1Vo) {
        JdbcFinder finder = JdbcFinder.create("select * from log_device_event a where 1=1");
        ...
        if(StringUtils.isNotBlank(eventV1Vo.getEstartTime())){
            finder.search("a.startTime", eventV1Vo.getEstartTime()+" 23:59:59 9999", JdbcFinder.SearchType.LE);
        }
